            ...
            <FlatList  
                ...
                <View style={{flexDirection:'row',alignItems:'center'}}>
                    ...
                    <View style={styles1.view}>
                        ...
                        <TextInput keyboardType='numeric'  onChangeText={(value)=>setquantidadeestoque(value)} placeholder='...' style={styles1.view2}/>
                ...
                <View style={{marginTop:20,flexDirection:"column"}}>
                    ...
                    <View >
                        <View style={{width:'100%'}}>
                            ...
                            <View style={{flexDirection:'row'}}>
                                <TextInput keyboardType='numeric'  onChangeText={(value)=>{sethh(value.replace(',','.'))}} style={styles.view2} placeholder="Ex.: 10"/>
                        ...
                        <View style={{width:'100%'}}>
                            ...
                            <View style={{flexDirection:'row'}}>
                                <TextInput keyboardType='numeric'  onChangeText={(value)=>{sethora(value.replace(',','.'))}} style={styles.view2} placeholder="Ex.: 10"/>
